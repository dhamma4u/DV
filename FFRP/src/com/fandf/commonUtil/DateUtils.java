...
public class DateUtils {
    ...
    /***
     * This date is the date of before date.
     * if u want before days, pass -ve (no. of days) and if u want after days, pass +ve (no. of Days).
     * @return Date of the days before 
     */
    public static Date getDateBeforeAfterDays(int daysBefore)
    {
        Calendar c = Calendar.getInstance();
        c.setTime(new Date());
    ...
    public static final String FACEBOOK_DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ssZZZZ" ;
    public static final String IST_DATE_FORMAT = "E MMM dd hh:mm:ss Z yyyy" ;
     ...
     * @return
     */
    public static String getFormatedDate(Date dateToFomat , String currentDateFormat, String newDateFormat)
    {
    	if ( (dateToFomat == null) || (newDateFormat == null))
    		return null ;
    	SimpleDateFormat sdf = new SimpleDateFormat(newDateFormat) ;
    	try 
    	{
			return sdf.format(dateToFomat) ;
		} catch (Exception e) 
    	{
			e.printStackTrace();
		}
     ...
     * @return
     */
    public static String getFormatedDate(String dateToFomat , String currentDateFormat, String newDateFormat)
    {
    	if ( (dateToFomat == null) || ( currentDateFormat == null) || (newDateFormat == null))
    		return null ;
    	SimpleDateFormat sdfCurrent = new SimpleDateFormat(currentDateFormat) ;
    	SimpleDateFormat sdfNew = new SimpleDateFormat(newDateFormat) ;
    	Date date = new Date() ;
    	try 
    	{
    		date = sdfCurrent.parse(dateToFomat) ;
